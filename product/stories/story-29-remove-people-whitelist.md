...
`product/product-decisions/current-architecture.md`, AGENTS.md. The build blueprint's "Old Mistakes" backs this
...
(CLAUDE.md; `product/product-decisions/current-architecture.md`). It remains in the tree with a second, stale "people"
...
4. Update CLAUDE.md and `product/product-decisions/current-architecture.md` to drop the "replaced by admin_api" line's
